...
private:
	...
	int qrindex;//��ά����
public:
	Map(string name1="/home/shylockwang/workspace/MyProject/map",string name2="/home/shylockwang/workspace/MyProject/qr",string name3="/home/shylockwang/workspace/MyProject/qrcoordinate");
